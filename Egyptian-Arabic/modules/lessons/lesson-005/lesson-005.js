  ...
  sections: [
    ...
    },
    {
      ...
      slides: [
        ...
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/018.png',
          convo: 'يلا بينا',
          speaker: speaker4,
          vocab: [
            {word: 'يلا بينا', meaning: "let's go", url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/019.png',
          convo: `انا اسمي ${arabSpeaker4}`,
          speaker: speaker4,
          vocab: [
            {word: 'اسمي', meaning: 'my name is', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/020.png',
          convo: `ودي عمتي`,
          speaker: speaker4,
          vocab: [
            {word: 'و', meaning: 'and', url: '/audio1970771774_01.mp3'},
            {word: 'عمة', meaning: 'aunt (father side)', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/021.png',
          convo: 'امك؟',
          speaker: speaker1,
          vocab: [
            {word: 'ام', meaning: 'mother', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/022.png',
          convo: 'لا مش امي، عمتي',
          speaker: speaker4,
          vocab: [
            {word: 'لا', meaning: 'no', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/023.png',
          convo: 'خد شوية شيبسي',
          speaker: speaker4,
          vocab: [
            {word: 'خد', meaning: 'take (informal)', url: '/audio1970771774_01.mp3'},
            {word: 'شوية', meaning: 'some/little', url: '/audio1970771774_01.mp3'},
            {word: 'شيبسي', meaning: 'chips', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/024.png',
          convo: 'شكرا',
          speaker: speaker1,
          vocab: [
            {word: 'شكرا', meaning: 'thanks', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/025.png',
          convo: 'عفوا',
          speaker: speaker4,
          vocab: [
            {word: 'عفوا', meaning: 'you are welcome', url: '/audio1970771774_01.mp3'},
          ]
        },
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/026.png',
        ...
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/027.png',
          convo: `اهلا ${arabSpeaker1}`,
          speaker: speaker4,
          vocab: [
            {word: 'مفيش جديد', meaning: 'no new words', url: '/audio1970771774_01.mp3'},
          ]
        ...
        {
          type: 'Story',
          imgURl: './modules/lessons/lesson-005/images/028.png',
          convo: `اهلا ${arabSpeaker4}`,
          speaker: speaker1,
          vocab: [
            {word: 'مفيش جديد', meaning: 'no new words', url: '/audio1970771774_01.mp3'},
          ]
